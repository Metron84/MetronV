...
function submitInquiryViaEmail(formData, segment, serviceType) {
  const email = 'info@metronventures.com';
...
function handleFormSubmit(event, formData, segment, serviceType) {
  ...
  try {
    ...
    alert('There was an error preparing your email. Please contact us directly at info@metronventures.com');
  ...
  successMessage.innerHTML = `
    <div class="success-content">
      ...
      <p style="font-size: 0.875rem; color: var(--text-secondary); margin-top: var(--space-md); padding: var(--space-sm); background: var(--off-white); border-left: 3px solid var(--accent-primary);">
        <strong>📧 Email Contact:</strong> Your email client should open automatically. If it doesn't, please send your inquiry to <a href="mailto:info@metronventures.com" style="color: var(--accent-primary);">info@metronventures.com</a> with Reference: <strong>${referenceNumber}</strong>
      </p>
      ...
      <div class="success-actions">
        ...
        <a href="mailto:info@metronventures.com?subject=Inquiry Reference: ${referenceNumber}" 
